...
| key | surface | content |
|---|---|---|
| (default) | COCKPIT | description, BRIEF (AGENT BRIEF only when an agent is bound), RECENT ITERATIONS (latest 5 finished, glyph + time + headline), NOTABLE ACTIVITY, objective RUNTIME |
