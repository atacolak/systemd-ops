...
remain unbounded unless a caller sets the thread-local timeout. `t` shows `<scope-root>/.systemd-ops/topology.txt` verbatim as operator explanation, not operational truth. Cockpit
